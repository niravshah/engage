...
jQuery(document).ready( function() {
    ...
    jQuery("#main-menu a, .logo a, .home-logo-text a, .menu a, .scroll-to").bind('click',function(event){
		...
		var headerH = jQuery('.header_wrap').height();
